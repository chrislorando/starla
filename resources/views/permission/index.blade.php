            ...
            <div class="card">
                <div class="card-header bg-dark text-white">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <form method="GET" action="{{ url('/permission/index') }}">
                                ...
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap text-center">
                                            <a href="{{ url('/permission/edit/'.$r->id) }}" class="btn btn-warning btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="#" class="btn btn-danger btn-sm" onclick="destroy('{{ url('/permission/destroy', ['id' => $r->id]) }}','{{ $r->name }}')">
