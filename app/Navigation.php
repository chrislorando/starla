...
class Navigation extends Model
{
     ...
     */
    protected $fillable = [
        'name', 'parent', 'route', 'type', 'sort', 'status', 'icon', 'data'
    ];
    ...
    {
        return $this->belongsTo('App\Navigation', 'parent', 'id');
    }

    public function childs()
    {
        return $this->hasMany('App\Navigation', 'parent', 'id')
        ->whereNotNull('parent')->orderBy('sort','ASC');
    }
}
